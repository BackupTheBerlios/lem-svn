		...
		if ("generate".equals( evt.getActionCommand() )) {
			...
			if (filenameField.getText().equals("")) {
				...
				if (subsystemList.getSelectedIndex() == 0) {
			        //	dotCode =ClassWriter.dumpDot( selectedDomain, selectedDomain.getClasses().values() );
                                        dotCode = ClassWriter.dumpUMLGraph( selectedDomain, selectedDomain.getClasses().values() );
                                        System.out.println(dotCode);                                           
					// The user has selected a specific subsystem
				} else {
				//	dotCode =ClassWriter.dumpDot( selectedDomain, selectedSubsystem.getClasses().values() );
                       		        dotCode =ClassWriter.dumpUMLGraph( selectedDomain, selectedSubsystem.getClasses().values() );     
                                        System.out.println(dotCode);
				}
