...
public class Visitor implements LemParserVisitor { 
	...
	*/
    ...
    public void setMapper( Mapper aMapper) {
	  ...
	  public Object visit(LEMScenarioDeclaration node, Object data) throws metamodel.LemException { 
		logVisit( node, data );
		node.childrenAccept( this, data );
		return data;
	}
	  ...
	  public Object visit(LEMCreationTransaction node, Object data) throws metamodel.LemException { 
		logVisit( node, data );
		node.childrenAccept( this, data );
		return data;
	}
	  ...
	  public Object visit(LEMPrintAction node, Object data) throws metamodel.LemException { 
		logVisit( node, data );
		node.childrenAccept( this, data );
		return data;
	}
	  ...
	  public Object visit(LEMOptionalParameterList node, Object data) throws metamodel.LemException { 
		logVisit( node, data );
		node.childrenAccept( this, data );
		return data;
	}
	  ...
	  public Object visit(LEMSelectMultiplicity node, Object data) throws metamodel.LemException { 
		logVisit( node, data );
		node.childrenAccept( this, data );
		return data;
	}
	  ...
	  public Object visit(LEMForStatement node, Object data) throws metamodel.LemException { 
		logVisit( node, data );
		node.childrenAccept( this, data );
		return data;
	}
	  ...
	  public Object visit(LEMRelatedTo node, Object data) throws metamodel.LemException { 
		logVisit( node, data );
		node.childrenAccept( this, data );
		return data;
	}
	  ...
	  public Object visit(LEMFunctionCall node, Object data) throws metamodel.LemException { 
		logVisit( node, data );
		node.childrenAccept( this, data );
		return data;
	}
