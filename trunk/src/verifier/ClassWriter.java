...
public class ClassWriter {
	 ...
	 *
	 * Some limitations exist with this feature:
	 * <ul>
	 *	<li> Association classes are not fully supported (the classes are displayed, but
	 *  the line linking the association class to its relationship is not shown)</li>
	 *  <li> Labels on generalisation hierarchy lines are not displayed </li>
	 * </ul>
	 *
