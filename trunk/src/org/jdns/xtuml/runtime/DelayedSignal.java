...
public class DelayedSignal extends Signal implements Comparable {
	private org.jdns.xtuml.runtime.Object target;
	 ...
	 */
	public DelayedSignal(Event e, org.jdns.xtuml.runtime.Object o, BigDecimal t) throws LemRuntimeException {
		super(e);
		target = o;
	...
	public org.jdns.xtuml.runtime.Object getTarget() {
		return target;
	}
