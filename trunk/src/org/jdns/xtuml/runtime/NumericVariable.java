 ...
 * NumericVariable should respect any constraints imposed by the variable's
 * DataType. For example, if the DataType is a DomainSpecificDataType, then
 * precision and range restrictions may be imposed.
 * 
 * NumericTypes, like other instances of Variable, are (usually) immutable. That
 * is, operations such as add() and subtract() will result in the creation of
...
public class NumericVariable extends Variable {
	 ...
	 *
	 * @param value the String representing the value of this numeric
	 * variable 
	 *
	 * @throws runtime.LemRuntimeException if <code>value</code>
	 * does not represent a valid Java BigDecimal when passed to
	 * BigDecimal's constructor 
	 *
	...
	/**
	 * Create a new instance of NumericVariable using the given BigDecimal as a
	 * value.
	 *
	...
	/**
	 * Create a new NumericVariable with the given DataType. This type is
	 *
	 * usually (but not necessarily) a DomainSpecificDataType specifying
	 * constraints on the value of this NumericVariable.
	 *
	 ...
	 *
	 * @param type the type, usually (but not necessarily) a
	...
	/**
	 * Adds this NumericVariable to the given Variable. If <code>right</code> is
	 * a StringType, then return a new StringVariable which is represents the
	 * String given by the Java statement:
	 * 
	 * <code>value.toString() + (String)right.getValue()</code>
	 * 
	 * That is, the String representation of the BigDecimal <code>value</code>
	 * is prepended to the String of the StringVariable on the right.
	 * 
	 ...
	 * @throws runtime.LemRuntimeException if <code>right</code> is not a
	 * NumericType or StringType
	...
	/**
	 * Returns a new variable representing the difference between
	 * <code>value</code> and the BigDecimal value of the <code>right</code>
	 * NumericType.
	 *
	 * @param right the variable to subtract
	 * @throws runtime.LemRuntimeException if <code>right</code> is not a
	 * NumericType
	 * @return a new NumericVariable representing the difference between this
	 * variable and <code>right</code>
	 */
	...
	/**
	 * Returns a new NumericVariable representing the product of this
	 * NumericVariable and the NumericVariable <code>right</code>.
	 *
	 * @param right the variable with which to multiply
	 * @throws runtime.LemRuntimeException if <code>right</code> is not a
	 * NumericType
	 * @return a new NumericVariable representing the BigDecimal product of this
	 * and <code>right</code>
	 */
	...
	/**
	 * Returns a new NumericVariable representing the quotient of this
	 * NumericVariable and the NumericVariable <code>right</code>.
	 *
	 * @param right the variable by which to divide
	 * @throws runtime.LemRuntimeException if <code>right</code> is not a
	 * NumericType
	 * @return a new NumericVariable representing the BigDecimal quotient of
	 * this and <code>right</code>
	 */
	 ...
	 * @throws runtime.LemRuntimeException if the call to equal() generates an
	 * exception
	...
	/**
	 * Returns the remainder of dividing this variable by the NumericVariable
	 * <code>b</code>.  
	 *
	 * Note, this is implemented using truncated integer divide in order to be
	 ...
	 * @return a new NumericVariable which contains the result of the
	 * BigDecimal.remainder() operation applied to this and <code>b</code>
	 ...
	 * @throws runtime.LemRuntimeException if <code>v</code> is not a
	 * NumericVariable
	...
	/**
	 * Returns a new BooleanVariable representing whether this NumericValue
	 * represents the same a lesser or equal value when compared to the given
	 * NumericValue.
	 *
	 * @param b the NumericVariable with which to compare 
	 * @throws runtime.LemRuntimeException if <code>b</code> is not a
	 * NumericVariable
	...
	/**
	 * Returns a new BooleanVariable representing whether this NumericValue
	 * represents the same a lesser value when compared to the given
	 * NumericValue.
	 *
	 * @param b the NumericVariable with which to compare 
	 * @throws runtime.LemRuntimeException if <code>b</code> is not a
	...
	/**
	 * Returns a new BooleanVariable representing whether this NumericValue
	 * represents the same an equal or greater value when compared to the given
	 * NumericValue.
	 *
	 * @param b the NumericVariable with which to compare 
	 * @throws runtime.LemRuntimeException if <code>b</code> is not a
	...
	/**
	 * Returns a new NumericVariable representing the negation (multiplication
	 * by -1) of this NumericVariable
	 *
	 * @throws runtime.LemRuntimeException 
	 * @return a new NumericVariable representing the negation of this
	 * NumericVariable
	 */
	 ...
	 * object is unconditionally cast to a BigDecimal, so it is up to the caller
	 * to ensure that the given Object is a BigDecimal.
	 *
